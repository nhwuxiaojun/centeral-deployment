...
<tr>
  <td height="50" ><img src="images/logo_ebaotech.gif" width="180" height="50"></td>
  <td>&nbsp;</td>
  <td width="235" >&nbsp;</td>
...
<tr>
  <td width="180" align="center" valign="top"><%@include file="include/main7.inc" %>
    </td><td><img src="images/1x1.gif" width="1" height="1"></td>
<td background="images/bg_vline.gif" valign="top"><img src="images/bg_vline.gif" width="1" height="4"></td><td align="center" valign="top">  <table height="220" border="0" cellpadding="0" cellspacing="0">
    <tr>
      	<td valign="top" align="center">
		hello!&nbsp;&nbsp;<%=session.getAttribute("username")%><br>
		<iframe id="iframe1" frameborder=0 name="ifra1" src="../ts_member_query.jsp" width="780" height="400"></iframe>
        </td>
    </tr>
  </table>
</td>
