...
<tr>
<td bgcolor="#646464" width="180"></td>
<td><img src="images/1x1.gif" width="8" height="8"></td>
<td height="25" colspan="2" bgcolor="#969696"><div align="right"><%@include file="include/topnav_ext.inc" %>
  </div> </td>
</tr>
</table>
<br>
...
<tr>
  <td width="180" align="center" valign="top"><%@include file="include/main_ext1.inc" %>
...
<td background="images/bg_vline.gif" valign="top"><img src="images/bg_vline.gif" width="1" height="4"></td><td width="791" align="center" valign="top">  <table width="95%" height="260" border="0" cellpadding="0" cellspacing="0">
    <tr>
		...
		hello!&nbsp;&nbsp;<%=session.getAttribute("ext_username")%><br>
		<iframe id="iframe1" frameborder=0 name="ifra1" src="../ext_db_access_privi.jsp" width="600" height="400"></iframe>
        </td>
    </tr>
  </table>
</td>
