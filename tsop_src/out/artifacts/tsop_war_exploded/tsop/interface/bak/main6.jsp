...
<tr>
  ...
  <td>&nbsp;</td>
  <td width="637" align="center" ><div align="right"><img src="images/slogan_ebaotech.gif" width="325" height="35"><br>
...
<tr>
  <td width="180" align="center" valign="top"><%@include file="include/main6.inc" %>
...
<td background="images/bg_vline.gif" valign="top"><img src="images/bg_vline.gif" width="1" height="4"></td><td width="791" align="center" valign="top">  <table width="95%" height="260" border="0" cellpadding="0" cellspacing="0">
    <tr>
		...
		<iframe id="iframe1" frameborder=0 name="ifra1" src="../assets_info_query.jsp" width="780" height="490"></iframe>
        </td>
    </tr>
  </table>
</td>
