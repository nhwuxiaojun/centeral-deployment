...
<html>
<head>
<title>Update Print Server Info</title>
...
<div align="center"><font color="#3333cc"><strong><br>
  <span class="s105">Update Print Server Info</span></strong></font>
</div>
<br><br>
<form name="form1" action="print_server_update_finish.jsp" method="get" class="en">
<table width="70%" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
	...
	<input type="hidden" value="<%=tmpid%>" name="print_id">
	<input type="hidden" value="<%=rs.getString("proj_id")%>" name="proj_id">
        <select name="proj_name" onChange="change_proj(document.form1.proj_code.options[document.form1.proj_code.selectedIndex].innerHTML)">
        	...
        	<% if ("".equals(request.getParameter("proj_name"))) {
                ...
                value="">Project Name</option>
                                ...
                                rs3 = db.execSQL(sql1);
                                while(rs3.next()){ %> 
		<option <% if (rs3.getString("proj_name").equals(rs.getString("proj_name"))) { out.print("selected=selected "); } %>
        value="<%=rs3.getString("proj_name")%>"  ><%=rs3.getString("proj_name")%> -- <%=rs3.getString("proj_id")%></option>
        <%}%>
        </select>
	</td>
	</tr>
	<tr>
	  ...
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="PRINT_USER" value="<%=rs.getString("PRINT_USER")%>" class="en" size="20"></td>
	</tr>
	<tr>
	  <td align="center" bgcolor="#D2D2D2" class="en" width="21%"><font color="#3333cc"><strong>Account Password</strong></font></td>
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="PRINT_PWD" value="<%=rs.getString("PRINT_PWD")%>" class="en" size="20"></td>
	</tr>
	<tr>
	  <td align="center" bgcolor="#D2D2D2" class="en" width="21%"><font color="#3333cc"><strong>IP</strong></font></td>
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="print_ip" value="<%=rs.getString("print_ip")%>" class="en" size="20"></td>
	</tr>
	<tr>
	  <td align="center" bgcolor="#D2D2D2" class="en" width="21%"><font color="#3333cc"><strong>OS</strong></font></td>
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="OS_TYPE" value="<%=rs.getString("OS_TYPE")%>" class="en" size="20"></td>
	</tr>
</table>
<br>
<div align="center">
<input type="button" name="button1" value="Update" onClick="check()">&nbsp;&nbsp;&nbsp;&nbsp;
