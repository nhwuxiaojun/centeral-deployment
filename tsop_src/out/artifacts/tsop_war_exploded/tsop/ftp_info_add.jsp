...
<html>
<head>
<title>Create FTP Account</title>
<meta http-equiv="Content-Type" content="text/html; charset=gbk">
<link href="css/ebao.css" rel="stylesheet" type="text/css">
<script language="JavaScript">
function change_proj(v_proj_name){
     form1.FTP_USER.value = v_proj_name.toLowerCase() + "_ftp";
     form1.FTP_DIR.value = "/home/"+v_proj_name.toLowerCase();
     form1.proj_name.value = v_proj_name.toLowerCase();
...
<table width="70%" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
	...
	<input type="hidden" name="proj_name">
        <select name="proj_code"  onChange="change_proj(document.form1.proj_code.options[document.form1.proj_code.selectedIndex].innerHTML.toLowerCase())">
                <option 
...
<br>
<div align="center">
<input type="button" name="button1" value="Create" onClick="check()">&nbsp;&nbsp;&nbsp;&nbsp;
<input type="reset" name="reset1" value="Reset">&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" name="button1" value="Close" onClick="window.close();">
</div>
</form>
</body>
<script language="JavaScript">
