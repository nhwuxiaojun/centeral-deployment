...
<%while(rs2.next()){%>
  <%if("2".equals(rs2.getString("valid"))){%>
	<tr bgcolor="#D2D2D2">
	  ...
	  <td align="center" class="en" width="8%"><font color="#3333cc"><strong>中文名</strong></font></td>
	...
	<tr bgcolor="#FCFCFC">
	  ...
	  <td align="center" class="en"><font color="#3333cc">&nbsp;<%=rs.getString("CNAME")%>&nbsp;</font></td>
	...
	<td align="center" class="en"><font color="#3333cc">&nbsp;<a href="ts_project_support_query.jsp?s_name=<%=rs.getLong("NO")%>&flag=print"><font color="#3333cc">查询</font></a></td>
	  <td align="center" class="en"><font color="#3333cc">&nbsp;<a href="ts_project_support_query.jsp?s_name=<%=rs.getLong("NO")%>&flag=print"><font color="#3333cc">
      <%
