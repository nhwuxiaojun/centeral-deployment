...
sql = sql + proj_grp + "','" + proj_dns + "','" + creater + "',to_date('" + crt_date + "','yyyy-mm-dd hh24:mi:ss'),'" + proposer + "','running','" + proj_code + "'," + id + ",'" + startup_script + "','" + note +  "','" + dms_type + "','"+ apply_type + "','" + print_type + "','" + print_ip + "','" + print_dir  + "','" + app_console +"')";
