...
<div align="center"><font color="#3333cc"><strong><br>
  <span class="s105">资产新增</span></strong></font>
</div>
<br><br>
<form name="form1" action="assets_info_add_finish.jsp" method="post" class="en">
<table width="70%" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
	<tr>
	  ...
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="ass_num" value="" class="en" size="35"></td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="opt_stat" value="" class="en" size="35"></td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="svr_price" value="" class="en" size="35"></td>
	</tr>
	<tr>
	  <td align="center" bgcolor="#D2D2D2" class="en" width="21%"><font color="#3333cc"><strong>购买日期</strong></font></td>
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="b_date" value="" class="en" size="35" onFocus="show_cele_date(b_date,'','',b_date)"></td>
	</tr>
	<tr>
	  <td align="center" bgcolor="#D2D2D2" class="en" width="21%"><font color="#3333cc"><strong>主机序列号</strong></font></td>
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="svr_sn" value="" class="en" size="35"></td>
	</tr>
</table>
<br>
<div align="center">
