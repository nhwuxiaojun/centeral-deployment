...
<center>
  ...
  <table width="95%">
    <tr> 
      ...
      Amend/Cancel Booking</font></strong></span></div></td>
    </tr>
  </table>
...
<form name="form1" action="projection_booking_done_upd.jsp" method="post">
<table width="98%" align="center" border="0">
  <tr>
      <td width="36%" height="394" valign="top"> 
        <center><b><font color="#FF0000" size="2"><%=Tools.toGB(request.getParameter("msg"))%></font></b></center>
        ...
        <table border="1" cellspacing="1" cellpadding="1" bordercolorlight="#00AEEF" bordercolordark="#E0E9FE">
          ...
          <tr> 
            <td width="300"><textarea name="reason" cols="41" rows="5" class="en"><%=rs1.getString("reason")%></textarea></td>
          </tr>
        </table>
		<p align="center">&nbsp; 
...
function check1(){
	...
	var dateObj1 = new Date(arr_projection_date[0], arr_projection_date[1], arr_projection_date[2], document.form1.start_hour.value, document.form1.start_minute.value, 0);
	var dateObj2 = new Date(arr_projection_date[0], arr_projection_date[1], arr_projection_date[2], document.form1.end_hour.value, document.form1.end_minute.value, 0);
	if(today-dateObj1>=0){
		alert("Date Error");
