...
// Write the SQL Query
$grid->SelectCommand = 'SELECT IP_LIST,IP_STATUS FROM a_ip;';
...
$grid->navigator = true;
$grid->setNavOptions('navigator', array("excel"=>false,"add"=>true,"edit"=>true,"del"=>true,"view"=>true, "search"=>false));
