...
var Validate = {
  ...
  Numericality: function(value, paramsObj){
    ...
    var params = { 
      notANumberMessage:  paramsObj.notANumberMessage || "必须是一个数字!",
      notAnIntegerMessage: paramsObj.notAnIntegerMessage || "必须是一个整数类型!",
      wrongNumberMessage: paramsObj.wrongNumberMessage || "必须是 " + paramsObj.is + "!",
      tooLowMessage:         paramsObj.tooLowMessage || "必须大于" + paramsObj.minimum + "!",
      tooHighMessage:        paramsObj.tooHighMessage || "必须小于 " + paramsObj.maximum + "!", 
  ...
  Email: function(value, paramsObj){
    var params = Object.extend({ 
      failureMessage: "请输入一个有效的Email地址!"
    }, paramsObj || {});
  ...
  Length: function(value, paramsObj){
    ...
    var paramsObj = paramsObj || {};
    var params = { 
      wrongLengthMessage: paramsObj.wrongLengthMessage || "请输入 " + paramsObj.is + " 长度的字符串!",
      tooShortMessage:      paramsObj.tooShortMessage || "请输入大于 " + paramsObj.minimum + " 长度的字符串!",
      tooLongMessage:       paramsObj.tooLongMessage || "请输入小于" + paramsObj.maximum + "  长度的字符串!",
      is:                           ((paramsObj.is) || (paramsObj.is == 0)) ? paramsObj.is : null,
      minimum:                  ((paramsObj.minimum) || (paramsObj.minimum == 0)) ? paramsObj.minimum : null,
      maximum:                 ((paramsObj.maximum) || (paramsObj.maximum == 0)) ? paramsObj.maximum : null
    }
