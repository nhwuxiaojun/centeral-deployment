...
<table id="maintable" width="98%" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E"
    ...
    <%
        sql_tmp = "SELECT  unique a.env_name, c.account A1, d.account A2 from ts_env a,  ts_proj b, ts_member c, ts_member d where a.proj_id = b.proj_id(+) and a.proj_name=b.proj_name(+) and b.owner1=c.no(+) and b.owner2=d.no(+) and a.env_name='" + rs.getString("ENV_NAME") + "'";
        // System.out.println("-1-----------");
