...
sql2="select distinct db_sid from ts_db";
...
<table width="80%" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
  ...
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>数据库IP：</strong></td>
    <td class="en" width="66%">
...
<SELECT name="DB_IP" onChange="change(document.form1.DB_IP.options[document.form1.DB_IP.selectedIndex].value)" > 
	  <option value="">请选择</option>
	  <%while(rs1.next()){%>
	    <option value="<%=rs1.getString("db_ip")%>"><%=rs1.getString("db_ip")%></option>
      <%}%>
	</select>	</td>
  </tr>
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>数据库实例名：</strong></td>
    <td class="en" width="66%">
	...
	<!--<input type="text" name="DB_SID" value="" class="en" size="35">-->	</td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>环境项目属组：</strong></td>
    <td class="en" width="66%">
	<select name="PROJECT_GROUP">
	  <option value="">请选择</option>
	  <%while(rs3.next()){%>
	    <option value="<%=rs3.getString("proj_grp")%>"><%=rs3.getString("proj_grp")%></option>
      <%}%>
	</select>	</td>
  </tr>
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>数据库环境申请人：</strong></td>
    <td class="en" width="66%"><input type="text" name="PROPOSER" value="" class="en" size="35"></td>
  </tr>
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>数据库环境创建人：</strong></td>
    <td class="en" width="66%"><input type="text" name="CREATER" value="" class="en" size="35"></td>
  </tr>
  <tr> 
