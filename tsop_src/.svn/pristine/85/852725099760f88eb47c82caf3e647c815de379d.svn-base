...
$xmlFile = $pacrudConfig['pacrudWebPath'].'/controller/groups.php';

$crudGroups = new paCRUD('objName=crudGroups,xmlFile='.$xmlFile.',schema='.$schema.',tableName=groups,routine=pacrud_groups');
$crudGroups->setConnection($pConnectionPacrud);
