...
<div align="center"><font color="#3333cc"><strong><br>
  <span class="s105">项目代码新增</span></strong></font>
</div>
<br><br>
<form name="form1" action="project_code_add_finish.jsp" method="post" class="en">
<center>
<table width="400" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
	<tr>
	  ...
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="proj_name" value="" class="en" size="35"></td>
	</tr>
	<tr>
	  <td align="center" bgcolor="#D2D2D2" class="en" width="21%"><font color="#3333cc"><strong>项目环境属组</strong></font></td>
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="proj_grp" value="" class="en" size="35"></td>
	</tr>
	<tr>
	  <td align="center" bgcolor="#D2D2D2" class="en" width="21%"><font color="#3333cc"><strong>Project Description</strong></font></td>
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="proj" value="" class="en" size="35"></td>
	</tr>
	<tr>
	  <td align="center" bgcolor="#D2D2D2" class="en" width="21%"><font color="#3333cc"><strong>项目代号</strong></font></td>
	  <td align="center" bgcolor="#FCFCFC" class="en"><input type="text" name="proj_code" value="" class="en" size="35"></td>
	</tr>
</table>
<center>
<br>
