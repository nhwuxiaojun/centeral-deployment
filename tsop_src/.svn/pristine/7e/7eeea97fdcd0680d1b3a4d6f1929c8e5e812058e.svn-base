...
<tr>
<td height="50" ><a href="http://ts.ebaotech.com/tsop/ext/"><img src="../images/logo_ebaotech.gif" border=0 /></a></td>
<td>&nbsp;</td>
...
<tr>
<td width="180" align="center" valign="top"><%@include file="include/main2.inc" %>
...
<iframe id="iframe1" frameborder=0 name="ifra1" src="../db_server_query.jsp" width="780" height="490"></iframe>
</td>
</tr>
</table>
</td>
