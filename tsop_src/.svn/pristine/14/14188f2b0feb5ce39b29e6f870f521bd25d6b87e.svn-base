...
require_once($pacrudConfig['pacrudPath'].'/model/functions_globals.php');
...
require_once($pacrudConfig['pacrudPath'].'/model/class_mariadb_connection.php');
require_once($pacrudConfig['pacrudPath'].'/model/class_sqlite3_connection.php');
...
require_once($pacrudConfig['pacrudPath'].'/model/class_queue.php');
require_once($pacrudConfig['pacrudPath'].'/model/class_queue_set.php');
...
require_once($pacrudConfig['pacrudPath'].'/model/class_crud_list.php');
require_once($pacrudConfig['pacrudPath'].'/model/class_tab.php');
