...
<div align="center"><font color="#3333cc"><strong><br>
  <span class="s105">单应用环境申请列表</span></strong></font>
</div>
...
<table width="98%" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
	...
	<tr bgcolor="#FCFCFC">
	  ...
	  <%while(rs_user.next()){%>
	  	<%if("2".equals(rs_user.getString("valid"))){%>
	  		<td align="center">&nbsp;<a href="only_app_db_build_del.jsp?id=<%=rs.getInt("id")%>&flag=1"><font color="#3333cc">删除</font></a>&nbsp;</td>
	  	<%}%>
	  <%}%>
    </tr>
	<%}%>
