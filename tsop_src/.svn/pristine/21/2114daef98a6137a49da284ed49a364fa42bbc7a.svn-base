...
$xmlFile = $pacrudConfig['pacrudWebPath'].'/controller/syslogin_groups.php';

$crudSysloginGroups = new paCRUD('objName=crudSysloginGroups,xmlFile='.$xmlFile.',parent1xN=crudUsers,schema='.$schema.',tableName=groups_syslogin');
$crudSysloginGroups->setConnection($pConnectionPacrud);
