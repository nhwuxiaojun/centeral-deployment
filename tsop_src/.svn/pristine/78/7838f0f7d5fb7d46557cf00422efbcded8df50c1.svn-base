...
$xmlFile = $pacrudConfig['pacrudWebPath'].'/controller/groups_syslogin.php';

$crudGroupsSyslogin = new paCRUD('objName=crudGroupsSyslogin,xmlFile='.$xmlFile.',parent1xN=crudGroups,schema='.$schema.',tableName=groups_syslogin');
$crudGroupsSyslogin->setConnection($pConnectionPacrud);
