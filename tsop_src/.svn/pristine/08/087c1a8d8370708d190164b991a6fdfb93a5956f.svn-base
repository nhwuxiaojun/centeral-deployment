...
ResultSet rs;
ResultSet rs_temp;
sql = "select * from ts_project where owner = " + request.getParameter("id");
rs = db.execSQL(sql);
%>
...
<table width="80%" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
  <tr> 
	...
	<input type="text" readonly="readonly" name="ENV_NO" value="<%=rs.getLong("NO")%>" class="en" size="35"></td>
  </tr>
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>域帐号：</strong></td>
    <td class="en" width="66%"><input type="text" name="ENV_ACCOUNT" value="<%=rs.getString("ACCOUNT")%>" class="en" size="35"></td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>中文名：</strong></td>
    <td class="en" width="66%"><input type="text" name="ENV_CNAME" value="<%=rs.getString("CNAME")%>" class="en" size="35"></td>
  </tr>
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>手机1：</strong></td>
    <td class="en" width="66%"><input type="text" name="ENV_MOBILE1" value="<%=rs.getLong("MOBILE1")%>" class="en" size="35"></td>
  </tr>
  <tr> 
    <td width="34%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>手机2：</strong></td>
    <td class="en" width="66%"><input type="text" name="ENV_MOBILE2" value="<%=rs.getLong("MOBILE2")%>" class="en" size="35"></td>
  </tr>
  <tr> 
...
function check(){
	...
	if(form1.ENV_CNAME.value==""){
		alert("请输入中文名！");
		form1.ENV_CNAME.focus();
		return;
	}
