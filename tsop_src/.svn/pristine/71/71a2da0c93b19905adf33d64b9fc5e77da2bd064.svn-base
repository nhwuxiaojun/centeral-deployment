...
<div align="center"><font color="#FF6600"><strong><br>
  <span class="s105">项目人员添加</span></strong></font>
</div>
<br><br>
<form name="form1" action="project_member_add_finish.jsp" method="post" class="en">
<table width="50%" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
  <tr> 
	...
	%>
	<select name="project_name" class="select1">
  ...
  <tr> 
    ...
    <td width="60%" align="center" class="en"><input type="text" name="start_date" value="" class="text" size="25" onFocus="show_cele_date(start_date,'','',start_date)"></td>
  </tr>
  <tr> 
    <td width="25%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>BA人数：</strong></td>
    <td class="en" width="60%" align="center"><input type="text" name="ba_member" value="" class="text" size="25"></td>
  </tr>
  <tr> 
    <td width="25%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>DM人数：</strong></td>
    <td width="60%" align="center" class="en"><input type="text" name="dm_member" value="" class="text" size="25"></td>
  </tr>
  <tr> 
    <td width="25%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>ST人数：</strong></td>
    <td width="60%" align="center" class="en"><input type="text" name="st_member" value="" class="text" size="25"></td>
  </tr>
  <tr> 
    <td width="25%" bgcolor="#D2D2D2" class="STYLE1 en"><strong>总人数：</strong></td>
    <td width="60%" align="center" class="en"><input type="text" name="total_member" value="" class="text" size="25"></td>
  </tr>
</table>
<br><br>
<div align="center">
<input type="button" name="button1" class="button1" value="添加" onClick="check()">&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" name="reset1" class="button1" value="重置">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="button2" value="返回" class="button1" onClick="return_back()">
</div>
</form>
<%db.close();%>
<%rs_project.close();%>
