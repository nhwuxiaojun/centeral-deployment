...
<tr>
<td width="180" align="center" valign="top"><%@include file="include/main3.inc" %>
...
<iframe id="iframe1" frameborder=0 name="ifra1" src="../project_build_manage.jsp" width="780" height="490"></iframe>
</td>
</tr>
</table>
</td>
