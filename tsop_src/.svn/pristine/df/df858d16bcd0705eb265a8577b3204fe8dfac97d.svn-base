...
<%
    ...
    try {
        ...
        while (rs_apply.next()) {
            ...
            proj_name = rs_apply.getString("proj_name");
...
// start of app env insert
            ...
            sql = sql + proj_grp + "','" + proj_dns + "','" + env_creator + "',sysdate,'" + proposer + "','running','" + proj_code + "','"+proj_name + "'," + id + ",'" + startup_script + "','" + note + "','" + dms_type + "','" + apply_type + "','" + print_type + "','" + print_ip + "','" + print_dir + "','" + app_console + "')";
...
// end of app env insert
            ...
            sql_temp = "insert into a_db_svr(db_ip,db_sid,db_ldap_name,db_user,db_user_passwd,db_user_type,proj_env,creater,db_status,proj_code,proj_name,db_id) values('" + db_ip + "','" + db_sid + "','" + db_ldap_name + "','" + owner_name + "','" + owner_name + "pwd','owner','" + new_env + "','" + env_creator + "','running','" + proj_code+"','"+proj_name + "',s_db__id.nextval)";
            System.out.println(sql_temp);
