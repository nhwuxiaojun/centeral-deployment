...
<table width="750" border="1" cellpadding="1" cellspacing="1" bordercolorlight="#9E9E9E" bordercolordark="#EFEFEF" align="center">
		...
		<td  bgcolor="#FCFCFC" class="td_title"><font color="#0000FF">
			<%
				...
				while(rs3.next()){
					...
					out.print("jdbc:oracle:thin:@"+rs3.getString("DB_IP")+":"+rs3.getString("DB_PORT_NUM")+":"+rs3.getString("DB_SID"));
				}
			%>
		</font></td>
	</tr>
	...
	<tr>
		<td  bgcolor="#D2D2D2" class="td_title"><font color="#0000FF"><strong>±¸×¢</strong></font></td>
		<td  bgcolor="#FCFCFC" class="td_title"><font color="#0000FF"><% out.print(note11);%></font></td>
	</tr>
	<% System.out.println("****************************************************\n"); %>
</table>
<br>
