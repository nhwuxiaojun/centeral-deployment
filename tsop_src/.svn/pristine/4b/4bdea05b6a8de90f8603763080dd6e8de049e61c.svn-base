...
<%
if(j==1){
	response.sendRedirect("env_access_privi_query.jsp?info=Delete Succeed!");
}else{
	response.sendRedirect("env_access_privi_query.jsp?info=Delete Failed!");
}
%>
